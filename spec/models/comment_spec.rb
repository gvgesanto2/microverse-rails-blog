...
RSpec.describe Comment, type: :model do
  subject do
    fake_user = User.new(name: 'User Test', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Brazil.')
    fake_post = Post.create(title: 'testing', author: fake_user, text: 'testing') 
    Comment.new(author: fake_user, post: fake_post, text: 'testing')
  end
